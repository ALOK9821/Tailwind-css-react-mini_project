...
const Card = () => {
   ...
   <div className="flex mx-9 my-4  hover:shadow-lg sm:mx-2">
 <form className="flex-auto p-6">
    ...
    <div className="flex items-baseline mt-4 mb-6">
      <div className="space-x-2 flex">
       Lorem ipsum dolor sit amet <br /> consectetur adipisicing elit. <br />  Autem accusamus odit magni 
      </div>
    ...
    <div className="flex space-x-3 mb-4 text-sm font-medium">
      <div className="flex-auto flex space-x-3">
        <button className="w-1/2 flex items-center justify-center rounded-md bg-black text-white" type="button">Buy now</button>
